...
// Polls bin/notch-network-stats independently of items/upload.qml (which
...
Item {
  ...
  readonly property color downloadColor: "#42a5f5"
  ...
  readonly property color ringColor: root.downloadColor
  ...
  readonly property string bottomLabel: root.known ? root.formatRate(root.rxRate) : "--"
